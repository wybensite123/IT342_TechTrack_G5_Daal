...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton btnBackArrow;
  ...
  private FragmentHomeBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnBackArrow,
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageButton btnBackArrow = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentHomeBinding((LinearLayout) rootView, btnBackArrow, chipGroupCategories,
          etSearch, progressBar, recyclerAssets, swipeRefresh, tilSearch, tvEmpty, tvError);
    }
